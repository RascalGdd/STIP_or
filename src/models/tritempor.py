            ...
            if self.training:
                ...
                if self.args.use_hard_mining_for_relation_discovery:
                    ...
                    all_rel_reps, union_feats = self.coarse_relation_feature_extractor(all_pairs,
                                                                                       ...
                                                                                       idx=imgid,
                                                                                       features_multiview=relation_feature_map_multiview, point_poses=point_2dxy[imgid], point_features=point_features[imgid])
...
class RelationFeatureExtractor(nn.Module):
    ...
    def forward(self, rel_pairs, features, boxes, inst_reprs, idx, obj_label_logits=None, features_multiview=None, point_poses=None, point_features=None):
        ...
        aux_x = self.aux_fc(relation_feats)
