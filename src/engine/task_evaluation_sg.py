...
from src.engine.lib.openimages_evaluation.ap_eval_rel import ap_eval, prepare_mAP_dets, bbox_overlaps
from src.engine.lib.pytorch_misc import intersect_2d, argsort_desc
...
def eval_rel_results(all_results, topk=100, do_val=True, do_vis=False):
    ...
    if do_val:
        ...
        if eval_ap:
            ...
            all_npos = sum(npos)
            with open('data/4dor/rel.json') as f: #TODO relative path!!!!!!!!!!!
